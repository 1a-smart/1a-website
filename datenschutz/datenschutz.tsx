      ...
      <section className="py-20 bg-white min-h-screen">
        <div className={containerClass}>
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-8 text-blue-700">
              Datenschutzerklärung
            </h1>
            <div className="bg-gray-100 rounded-lg p-8 space-y-6 text-gray-700 prose prose-lg max-w-none">
              <h2 className="text-2xl font-semibold mb-4 text-blue-700">
                1. Datenschutz auf einen Blick
              </h2>

              <h3 className="text-xl font-semibold mb-2 text-blue-700 mt-4">Allgemeine Hinweise</h3>
              <p>
              ...
              <h2 className="text-2xl font-semibold mb-4 text-blue-700">2. Hosting</h2>

              <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>

              <h3 className="text-xl font-semibold mb-2 text-blue-700 mt-4">Externes Hosting</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mb-2 text-blue-700 mt-4">Datenschutz</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mb-2 text-blue-700 mt-4">Speicherdauer</h3>
              <p>
              ...
              <h3 className="text-xl font-semibold mb-2 text-blue-700 mt-4">Cookies</h3>
              <p>
